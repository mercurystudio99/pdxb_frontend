...
import LoginModal2 from "../LoginModal2/LoginModal2";
import EmailLoginModal2 from "../EmailLoginModal2/EmailLoginModal2";
const LoginOptionsModal2 = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      {showMobileModal && (
        <LoginModal2 isOpen={showMobileModal} onClose={handleCloseModal} />
      )}
      {showEmailModal && (
        <EmailLoginModal2
...
export default LoginOptionsModal2;
