...
export default function EditPropertyTabs() {
  ...
  const packageId =
    SettingsData?.package?.user_purchased_package[0]?.package_id;
      ...
      onSuccess: (response) => {
        ...
        if (propertyData) {
          setTab1({
            ...
            agent: propertyData.agentid,
            agentDisplayed: (propertyData.agent_type == 1)? propertyData.agentid : "main",
            agentType: propertyData.agent_type,
            ...
            rentduration:
              propertyData.rentduration === "Daily"
                ...
                ? "Quarterly"
                : "",
            dldPermitNumber: propertyData.dld_permit_number || "",
          });
  ...
  const handleUpdatePostproperty = (e) => {
    ...
    if (!areFieldsFilled(tab1)) {
      ...
      toast.error(
        "Please select a location with all required fields (city, state, country, and formatted_address)"
      );
      // Switch to Tab 4
      setValue(4);
                            ...
                            <div className="col-sm-12" key={optionIndex}>
                              <div className="custom-checkbox">
                                <input
                                  ...
                                  checked={
                                    tab2[`${ele.id}_${optionIndex}`] || false
                                  }
                                  onChange={(e) =>
