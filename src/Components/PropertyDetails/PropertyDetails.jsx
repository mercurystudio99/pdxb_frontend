...
const PropertyDetails = () => {
  ...
  const whatsappMessage = `Hi, I am interested in your property on PDXB. Link: ${currentUrl}`;
              ...
              <div className="container">
                ...
                <div className="row" id="prop-all-deatils-cards">
                  ...
                  <div className="col-12 col-md-12 col-lg-3">
                      ...
                      <div className="card-body">
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <div id="mail-o" style={{ display: "flex" }}>
                                <IoIosCall size={20} />
                        ...
                        <div className="enquiry">
                          {!isReported ? (
                            ...
                            >
                              {" "}
                              <MdReport className="mx-1" size={20} />
                              {translate("reportProp")}
                            </button>
                          ) : null}
                    ...
                    <div className="card mt-3" id="owner-deatils-card">
                      <div className="card-header" id="card-owner-header">
                        <div className="owner-deatils">
                          <span className="owner-name">
                      ...
                      <div className="card-body ">
                        <div className="non-pointer-owner-contact">
                          <div>
                            <BiBarcode id="company-details" size={35} />
                            <span className="o-d ms-2 me-1">
                              {translate("dldPermitNumber")}
                              <FaInfoCircle
                                className="ms-2"
                                size={20}
                                data-tooltip-id={"dld-tool-tip"}
                                data-tooltip-content="This is the permit number issued by the Dubai Land Department (DLD) for the property."
                              />
                            </span>
                          </div>
                          <div className="deatilss">
                            <span className="value me-2">
                              {getPropData && getPropData.dld_permit_number}
                            </span>
                          </div>
                        </div>
                        ...
                        {getPropData && getPropData.whatsapp_number && (
                          <div className="non-pointer-owner-contact">
                            <div>
                              <MdBusiness id="company-details" size={35} />
                              <span className="o-d ms-2 ">
                                {translate("ornNumber")}
                                <FaInfoCircle
                                  className="ms-2"
                                  size={20}
                                  data-tooltip-id={"orn-tool-tip"}
                                  data-tooltip-content="Issued to RERA registered companies and is used to identify the company in the real estate market."
                                />
                              </span>
                            </div>
                            <div className="deatilss">
                              <span className="value me-2">
                                {getPropData && getPropData.orn_number}
                              </span>
                            </div>
                          </div>
                        )}
